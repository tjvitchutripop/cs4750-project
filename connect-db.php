...
//  $db = new PDO("mysql:host=$hostname;dbname=db-demo", $username, $password);
   ...
   debug_to_console("You are connected to the database -- host=$host");
}
catch (PDOException $e)     // handle a PDO exception (errors thrown by the PDO library)
{
   ...
   debug_to_console("An error occurred while connecting to the database: $error_message");
}
catch (Exception $e)       // handle any type of exception
{
   $error_message = $e->getMessage();
   debug_to_console("Error message: $error_message");
}
